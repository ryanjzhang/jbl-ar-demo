...
THREE.JeelizHelper = (function(){
  ...
  const that = {
    ...
    update_camera: function(threeCamera){
      ...
      console.log('DOM width: ', _threeRenderer.domElement.width, 'height: ', _threeRenderer.domElement.height,
      'scale: ', scale, 'cvws: ', cvws, 'offsetX: ', offsetX , 'offsetY: ', offsetY, 'cvw: ', cvw)
    }
  }
  return that;
})();